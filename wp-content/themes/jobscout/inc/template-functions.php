...
function jobscout_footer_top(){    
    ...
    if( $active_sidebars ){ ?>
        <div class="footer-t" style="background-color: #F2F2F2; ">
    		<div class="container">
            <h3>
